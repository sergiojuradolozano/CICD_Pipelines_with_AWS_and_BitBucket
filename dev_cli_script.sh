...
aws cloudformation deploy --template-file ./Pipelines/CodePipelineS3ArtifactsBucket.yaml --stack-name CodePipelineS3ArtifactsBucket --capabilities CAPABILITY_IAM CAPABILITY_NAMED_IAM --parameter-overrides Environment=dev Region=us-east-1 #See comment on the Region parameter in the cloudformation stacks.
...
aws cloudformation deploy --template-file ./Pipelines/Application-CodePipeline.yaml --stack-name Application-CodePipeline --capabilities CAPABILITY_IAM CAPABILITY_NAMED_IAM --parameter-overrides Environment=dev Region=us-east-1 #See comment on the Region parameter in the cloudformation stacks.
